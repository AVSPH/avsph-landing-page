...
export default function OperationsPage() {
    return (
        <>
                ...
                <div className="container relative z-10">
                    <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                        ...
                        <div className="text-left animate-slide-up">
                            <span className="inline-block py-2 px-4 rounded-full bg-indigo-50 text-indigo-600 font-bold text-sm tracking-wide mb-6 border border-indigo-100">
                                Professional Business Operations
                            </span>
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold mb-6 text-[var(--primary)] leading-tight">
                                Streamline Your <br />
                                <span className="text-[var(--accent)]">Business Operations.</span>
                            </h1>
            ...
            <CTABookACall
                title="Build a scalable operation."
                subtitle="Schedule a free consultation to discuss your operations and task coordination needs and find your perfect virtual assistant match."
            />
        </>
    );
}
