        ...
        <div className="w-full relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {MOCKUPS.map((mockup, i) => (
                    ...
                    >
                        {/* Mockup Preview container - height restricted to suggest it's a long page */}
                        <div className="relative h-[400px] w-full overflow-hidden bg-gray-100">
                            {/* We use standard img to allow natural scaling of the top portion */}
                            <img 
                                src={mockup.image} 
                        ...
                        <div className="p-5 bg-white flex justify-between items-center relative z-10">
                            <div>
                                <h3 className="font-bold text-gray-900 text-lg">{mockup.title}</h3>
                                <p className="text-sm text-gray-500 font-medium tracking-wide uppercase mt-1">{mockup.category}</p>
                            </div>
                            <a 
                                href={mockup.url} 
                                target="_blank" 
                                rel="noopener noreferrer"
                                className="p-3 bg-gray-100 hover:bg-[var(--accent)] hover:text-white rounded-none transition-colors duration-300"
            ...
            {activeMockup && (
                ...
                >
                    ...
                    <div 
                        className="relative w-full max-w-5xl mt-16 md:mt-12 mx-auto bg-gray-900 shadow-2xl animate-[fade-in-up_0.4s_ease-out]"
