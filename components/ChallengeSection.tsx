  ...
  const challenges = [
    {
      ...
      description:
        "Free up 20+ hours per week by delegating admin work, data entry, and routine operations.",
    },
    {
      icon: <Users className="w-6 h-6" />,
      title: "Struggling to find reliable talent?",
      description:
        "Access our pre-vetted pool of exceptional virtual assistants.",
    },
    {
      icon: <DollarSign className="w-6 h-6" />,
      title: "Worried about the cost of hiring?",
      description:
        "Save up to 70% compared to local hires with our affordable hourly rates and zero overhead costs.",
    },
  ];
      ...
      <div className="container">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            >
              As a business owner, you wear too many hats. Your time is
              valuable, and spending it on tasks that could be delegated is
              costing you growth opportunities.
            </p>
            ...
            >
              <div className="text-white">
                ...
                <p className="text-white/80 mb-6">
                  ...
                  performance monitoring, we provide end-to-end staffing
                  solutions so you can focus on what matters.
                </p>
